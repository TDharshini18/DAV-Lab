...
## 🔬 Experiments 8–16 — Remaining Lab Manual Experiments

The repository now continues through all remaining experiments in the uploaded DAV lab manual:

| # | Experiment | Main Topics |
|:-:|:-----------|:------------|
| 8 | **Multiple Regression Analysis** | Multiple Linear Regression, R² |
| 9 | **Comparison of Analysis Results** | UCI vs Pima statistical/model comparison |
| 10 | **Normal Curves** | Histograms, KDE, Normal Distribution |
| 11 | **Z-Test** | Hypothesis testing, p-value |
| 12 | **T-Test** | Independent T-test |
| 13 | **ANOVA** | One-Way ANOVA, significance testing |
| 14 | **Linear Model Validation** | R², MSE, MAE, prediction plots |
| 15 | **Logistic Model Validation** | Accuracy, Precision, Recall, F1, Confusion Matrix |
| 16 | **Time Series Analysis** | Trend, Seasonality, Moving Average, ARIMA |

Each folder contains the Python implementation, an executable Jupyter notebook, required datasets, and generated plots where applicable. Relative file paths are used so the experiments can be run directly after cloning the repository.
